...
const services = [
    ...
    },
    {
        ...
        techIcons: [LinuxIcon, ProxmoxIcon]
    }
];
                ...
                {services.map(service => (
                    <div key={service.id} className="rounded-2xl shadow-sm p-6 hover:shadow-md transition">
                        <div className="flex items-center gap-3 mb-4">
                            <div className="bg-blue-600 text-white font-bold w-10 h-10 flex items-center justify-center rounded-xl px-4">
                                {service.id}
                            </div>
                        ...
                        <p className="text-md text-gray-600 mb-4 text-justify">{service.description}</p>
